...
contract DeployUnichainSepolia is Script {
    // Mock USDC on Unichain Sepolia — update to actual address once deployed
    ...
    function run() external {
        ...
        console.log("Update MANTUA_PREDICTION_MARKET[1301] in client/src/config/contracts.ts");
    }
}
